...
namespace BeerTap.WebApi.Infrastructure
{
    ...
    public class DefaultApiContainer : ApiContainer
    {
        ...
        readonly Assembly _apiDomainServicesAssembly = typeof(Domain.IBeerTapService).Assembly;
        readonly Assembly _resourceMappersAssembly = typeof(OfficeMapper).Assembly;
